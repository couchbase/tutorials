...
====== {empty}
++++
<div data-level="beginner" data-category="beginner java nodejs dotnet developer" class="sub-heading two-column-heading">
...
Beginner</h5>
<span data-role="beginner">Developer</span>
</div>
</div>
++++
[.content]
...
====== {empty}
++++
    <div data-level="beginner" data-category="beginner java nodejs developer"  class="sub-heading two-column-heading">
...
====== {empty}
++++
    <div data-level="beginner" data-category="beginner swift mobile developer" class="sub-heading two-column-heading">
        <h3 class="text-color-brand-blue-secondary">Get Started with Couchbase Mobile on iOS</h3>
        <div class="filter-info">
        <h5 >
        <img src="_/img/landing-page-icon/beginner-icon.svg" alt="" />
        Beginner</h5>
        <span data-role="beginner">Mobile Developer</span>
        </div>
    </div>
++++
[.content]
...
====== {empty}
++++
    <div data-level="beginner" data-category="beginner android mobile developer" class="sub-heading two-column-heading">
...
====== {empty}
++++
    <div data-level="beginner" data-category="beginner c# mobile developer" class="sub-heading two-column-heading">
...
====== {empty}
++++
    <div data-level="beginner" data-category="beginner swift java javascript mobile developer" class="sub-heading two-column-heading">
...
====== {empty}
++++
    <div data-level="beginner" data-category="beginner android java dotnet mobile developer" class="sub-heading two-column-heading">
...
====== {empty}
++++
    <div data-level="beginner" data-category="beginner java dotnet developer" class="sub-heading two-column-heading">
...
====== {empty}
++++
    <div data-level="intermediate" data-category="intermediate swift android java c# mobile developer" class="sub-heading two-column-heading">
        ...
        Intermediate</h5>
        <span data-role="intermediate">Mobile Developer</span>
        </div>
    </div>
++++
[.content]
...
====== {empty}
++++
    <div data-level="intermediate" data-category="intermediate javascript developer" class="sub-heading two-column-heading">
        <h3 class="text-color-brand-blue-secondary">Customer 360 Data Ingestion</h3>
        <div class="filter-info">
        <h5 >
        <img src="_/img/landing-page-icon/intermediate-icon.svg" alt="" />
        Intermediate</h5>
        <span data-role="intermediate">Developer</span>
        </div>
    </div>
++++
[.content]
...
====== {empty}
++++
    <div data-level="intermediate" data-category="intermediate java c# developer" class="sub-heading two-column-heading">
...
====== {empty}
++++
    <div data-level="intermediate" data-category="intermediate java developer" class="sub-heading two-column-heading">
...
====== {empty}
++++
    <div data-level="intermediate" data-category="intermediate java mobile developer" class="sub-heading two-column-heading">
...
====== {empty}
++++
    <div data-level="beginner" data-category="beginner developer" class="sub-heading two-column-heading">
