...
====== {empty}
++++
    <div data-category="intermediate swift mobile developer" class="sub-heading two-column-heading">
        <h3 class="text-color-brand-blue-secondary">Getting Started with Peer-to-Peer Sync on iOS</h3>
        <div class="filter-info">
        <h5 >
...
xref:tutorials:cbl-p2p-sync-websockets:swift/cbl-p2p-sync-websockets.adoc[Start Here]
...
====== {empty}
++++
    <div data-category="intermediate android mobile developer" class="sub-heading two-column-heading">
        <h3 class="text-color-brand-blue-secondary">Getting Started with Peer-to-Peer Sync on Android</h3>
        <div class="filter-info">
        <h5 >
        <img src="_/img/landing-page-icon/intermediate-icon.svg" alt="" />
        Intermediate</h5>
...
xref:tutorials:cbl-p2p-sync-websockets:android/cbl-p2p-sync-websockets.adoc[Start Here]
...
++++
    <div data-category="intermediate java mobile developer" class="sub-heading two-column-heading">
        <h3 class="text-color-brand-blue-secondary">Getting Started with Peer-to-Peer Sync on Java</h3>
        <div class="filter-info">
        <h5 >
        <img src="_/img/landing-page-icon/intermediate-icon.svg" alt="" />
        Intermediate</h5>
...
xref:tutorials:cbl-p2p-sync-websockets:java/cbl-p2p-sync-websockets.adoc[Start Here]
...
====== {empty}
++++
    <div data-category="intermediate csharp mobile developer" class="sub-heading two-column-heading">
        <h3 class="text-color-brand-blue-secondary">Getting Started with Peer-to-Peer Sync on C#</h3>
        <div class="filter-info">
        <h5 >
        <img src="_/img/landing-page-icon/intermediate-icon.svg" alt="" />
        Intermediate</h5>
...
xref:tutorials:cbl-p2p-sync-websockets:csharp/cbl-p2p-sync-websockets.adoc[Start Here]
